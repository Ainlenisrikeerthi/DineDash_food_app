              ...
              <div className="card">
                <div className="card-content">
                  ...
                  <blockquote className="card-text">
                    "DineDash has completely transformed our dining experience at home. The food is always fresh,
                    flavorful, and delivered on time. Their app is so easy to use, and I love the variety of restaurants
                    available. The convenience and quality make it our go-to choice for a hassle-free meal!"
                  </blockquote>
                </div>
                ...
                <div className="card-footer">
                  ...
                  <div className="card-user-info">
                    ...
                    <p className="card-user-role">Food Enthusiast</p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="card-content">
                  ...
                  <blockquote className="card-text">
                    "We love DineDash for its exceptional service and delicious food. From their prompt delivery to the
                    scrumptious, well-packaged meals, they never disappoint. The tracking feature is fantastic - I can
                    see exactly when my food will arrive. Their loyalty program gives great discounts too!"
                  </blockquote>
                </div>
                ...
                <div className="card-footer">
                  ...
                  <div className="card-user-info">
                    ...
                    <p className="card-user-role">Regular Customer</p>
                  </div>
                </div>
              </div>
              <div className="card">
                <div className="card-content">
                  ...
                  <blockquote className="card-text">
                    "DineDash consistently exceeds our expectations. The online ordering process is seamless, and the
                    food arrives hot and tasty every time. I've tried many delivery apps, but DineDash has the best
                    selection of restaurants and the most reliable service. Highly recommended!"
                  </blockquote>
                </div>
